...
card:
  entity: swift_blink
  sentences:
  - text: Swift Blink is a component-quality item costing 6800 gold that grants 25
      Agility; its active teleports the user within 1200 cast range, then grants phased
      movement, 40% bonus movement, and 35 bonus Agility for 6 seconds.
    marks:
  ...
  - text: The active has a mana cost of 0.
    marks:
    - gamefile:items/item_swift_blink#mechanics
  - text: The active has a 15.0-second cooldown.
    marks:
    - gamefile:items/item_swift_blink#mechanics
  - text: Its behavior is Point Target, DOTA_ABILITY_BEHAVIOR_DIRECTIONAL, DOTA_ABILITY_BEHAVIOR_ROOT_DISABLES,
      and DOTA_ABILITY_BEHAVIOR_OVERSHOOT.
    marks:
    - gamefile:items/item_swift_blink#mechanics
  ...
  - text: A cunning blade able to anticipate and enable its bearer's movements.
    marks:
    - loc:DOTA_Tooltip_ability_item_swift_blink_Lore
---
