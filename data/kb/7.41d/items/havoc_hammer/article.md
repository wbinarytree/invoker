...
card:
  entity: havoc_hammer
  sentences:
  - text: Havoc Hammer is a 0-gold item that grants 16 Damage and 14 Strength; its
      immediate, no-target Havoc active has a 10.0 cooldown, pulls surrounding enemies
      100 within 400 range, deals magical damage with 175 Nuke Base Damage and 1.5
      Nuke Strength Damage, and applies a 50% Slow for 3 Slow Duration.
    marks:
  ...
  - text: Havoc has an Angle of 360.
    marks:
    - gamefile:items/item_havoc_hammer#attribs
  - text: Its Knockback Duration is 0.2.
    marks:
    - gamefile:items/item_havoc_hammer#attribs
  - text: The build formula is Havoc Hammer (0 gold).
    marks:
    - gamefile:items/item_havoc_hammer#cost
---
