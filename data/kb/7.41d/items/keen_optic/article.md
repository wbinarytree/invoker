...
Keen Optic is an item that provides Mana Regeneration and Cast Range. [gamefile:items/item_keen_optic#cost] [gamefile:items/item_keen_optic#attribs]
...
Its behavior is passive. [gamefile:items/item_keen_optic#mechanics]

*Stolen from a tinker's shop ages ago, this handy lens has seen service to many owners.* [loc:DOTA_Tooltip_ability_item_keen_optic_Lore]