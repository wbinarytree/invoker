...
card:
  entity: bottle
  sentences:
  - text: Bottle is a common 675-gold, 3-charge item whose active Regenerate restores
      110 Health and 60 Mana over 2.7 seconds and whose passive Store Rune stores
      Runes for 90.0 seconds.
    marks:
    - gamefile:items/item_bottle#cost
    - gamefile:items/item_bottle#attribs
    - loc:DOTA_Tooltip_ability_item_bottle_Description
  - text: Its build formula is Bottle (675 gold).
    marks:
    - gamefile:items/item_bottle#cost
  - text: Bottle has 350 Cast Range.
    marks:
    - gamefile:items/item_bottle#mechanics
  - text: Bottle has a 0.5 Cooldown.
    marks:
    - gamefile:items/item_bottle#mechanics
  ...
  - text: Holding Control uses Bottle on an allied hero.
    marks:
    - loc:DOTA_Tooltip_ability_item_bottle_Description
  - text: Right-clicking a Rune stores it for later use.
    marks:
    - loc:DOTA_Tooltip_ability_item_bottle_Description
  - text: An unused stored Rune activates automatically when its storage time expires.
    marks:
    - loc:DOTA_Tooltip_ability_item_bottle_Description
