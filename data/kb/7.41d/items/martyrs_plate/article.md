...
card:
  ...
  - text: Martyr's Plate is a 0-gold item that provides 7 Health Regeneration and
      25% Magic Resistance and grants Martyrdom, which redirects 25% of all magic
      damage dealt to allied heroes within a 900 radius to the user for 10.
    marks:
  ...
  - text: Martyrdom is immediate, requires no target, and has a 40 cooldown.
    marks:
    - gamefile:items/item_martyrs_plate#mechanics
  - text: Its build formula is Martyr's Plate (0 gold).
    marks:
    - gamefile:items/item_martyrs_plate#cost
---
