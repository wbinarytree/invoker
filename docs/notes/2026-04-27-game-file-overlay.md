...
Date: 2026-04-27
Status: superseded by [docs/archive/specs/2026-04-27-game-files-as-primary-constants.md](../archive/specs/2026-04-27-game-files-as-primary-constants.md). Retained as a design note — the overlay framing was abandoned in favor of game files as the primary source for constants.
