...
Invoker should produce a compact patch-scoped identity/localization artifact for
downstream consumers such as Phylactery. The first artifact covers source-backed
hero and item identity only:
